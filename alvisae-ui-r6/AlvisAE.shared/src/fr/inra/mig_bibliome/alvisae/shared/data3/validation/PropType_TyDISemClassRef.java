...
/**
 * Type of Annotation property that contains a reference to a SemanticClass of
 * TyDI, and allow the corresponding Annotation to be used to create new Class
 * or new Term via TyDI extension
 *
 * @author fpapazian
 */
