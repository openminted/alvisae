...
public class TyDIExt implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        if (testContainer != null) {
            ...
            //ResourceLocator locator = new ResourceLocator("http://inspiron7720:8080/tydirws/triphase2/projects/117227/");
            ResourceLocator locator = new ResourceLocator("http://inspiron7720:8080/tydirws/quaerobiotopes/projects/3/");
