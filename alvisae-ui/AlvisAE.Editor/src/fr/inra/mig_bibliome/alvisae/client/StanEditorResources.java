...
public interface StanEditorResources extends ClientBundle {
    ...
    @Source("images/tag--arrow.png")
    ImageResource RefAnnotIcon();
    ...
    @Source("images/navigation-000-button-white.png")
    ImageResource NextBlockIcon();

    @Source("images/arrow-transition-270.png")
    ImageResource AnnotationMergeIcon();

    @Source("images/arrow-continue-180-top-green.png")
    ImageResource AutoMergeAnnotationsIcon();

    @Source("images/node-delete-child.png")
    ImageResource ConsolidationSetUnmatchedIcon();

    @Source("images/node-delete-child_reversed.png")
    ImageResource ConsolidationClearUnmatchedIcon();

    @Source("images/disk-black.png")
    ImageResource SaveAnnotationsIcon();
