...
public class Selection {
    ...
    public static class TextAnnotationSelection extends GenericAnnotationSelection {
        ...
        /**
         *
         * @return The "Main" marker of the selected Annotation i.e. the one with focus or the one that was actually clicked
         */
    ...
    public static class AnnotationSelections {
        ...
        /**
         *
         * @return the main selected Annotation, i.e. the one with the focus, or the last selected one
         */
        ...
        /**
         *
         * @return true if the specified Annotation is contained in this multi-selection
         */
